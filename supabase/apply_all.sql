...
create table public.restaurants (
  ...
  apple_maps_url text,
  is_premium_partner boolean not null default false,
...
create index restaurants_premium_city_idx
...
-- Legt beim Registrieren automatisch ein Profil an (Rolle editor — Admin manuell setzen)
...
-- Ersten Admin setzen (nach erstem Login — UUID ersetzen):
-- update public.profiles set role = 'admin' where id = 'DEINE-USER-UUID';

-- ─── Security (siehe migrations/005 + 006) ───────────────────────────────────
