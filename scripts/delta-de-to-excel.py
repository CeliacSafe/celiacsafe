...
def delta_row_to_restaurant(row: dict[str, Any]) -> dict[str, Any]:
    ...
    record: dict[str, Any] = {
        ...
        "description_de": parse_string(row.get("verification_note")),
        "description_en": parse_string(row.get("verification_note")),
        "description_es": parse_string(row.get("verification_note")),
        "is_published": True,
        "is_hidden": False,
